 ...
 * @author Int16
 */
value class Proportion internal constructor(private val fraction: Double) :
  Comparable<Proportion> {
    ...
    operator fun plus(
      ...
      createProportion(
        ensureFraction(fraction + other.fraction),
      )
    ...
    override fun compareTo(
      ...
      fraction.compareTo(other.fraction)
    ...
    companion object {
      ...
      fun fromFraction(
        ...
        createProportion(ensureFraction(value))
      ...
      fun fromPercent(
        ...
        createProportion(percentToFraction(percent))
    }
  }
...
private fun formatProportionValue(
  percentValue: Double,
): String {
