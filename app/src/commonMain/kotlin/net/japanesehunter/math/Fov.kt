 ...
 * @author Int16
 */
value class Fov internal constructor(val angle: Angle) {
  init {
    require(angle > Angle.ZERO && angle < Angle.PI) {
      "Fov must satisfy 0 < angle < PI, was $angle"
    }
  }
  ...
  companion object {
    ...
    fun fromRadians(
      ...
      from(Angle.from(radians, AngleUnit.RADIAN))
    ...
    fun fromDegrees(
      ...
      from(Angle.from(degrees, AngleUnit.DEGREE))
  }
}
